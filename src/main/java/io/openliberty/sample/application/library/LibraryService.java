...
public class LibraryService {
    ...
    public String query(@QueryParam("no") int number) {
        List<Book> result = switch (number) {
            ...
            case 3 -> library.findBookByTitleStartsWith("The");
            case 4 -> library.findFirst3Book();
            case 5 -> library.findByTitleContains("er");
            case 6 -> library.findByPublishYearNotLessThan(2000);
